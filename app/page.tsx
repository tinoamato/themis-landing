...
<header class="site">
  <div class="header-inner">
    <a href="#" class="brand" aria-label="Themis — Volver al inicio">
      <svg class="brand-mark" width="30" height="30" viewBox="0 0 80 80" fill="none" role="img" aria-label="Balanza de la justicia estilizada">
        <title>Logo de Themis</title>
    ...
    <div class="header-cta">
      <a href="https://wa.me/5491144074979?text=Hola%2C%20me%20interesa%20solicitar%20una%20demo%20de%20Themis." target="_blank" rel="noopener noreferrer" class="btn btn-primary" aria-label="Solicitar demo por WhatsApp">
        Solicitar demo
  ...
  <div class="hero-grid">
    <div class="hero-left">
      ...
      <div class="hero-actions">
        <a href="https://wa.me/5491144074979?text=Hola%2C%20vi%20la%20web%20de%20Themis%20y%20me%20gustar%C3%ADa%20solicitar%20una%20demo." target="_blank" rel="noopener noreferrer" class="btn btn-primary accent lg" aria-label="Solicitar demo por WhatsApp">
    ...
    <div class="hero-right" id="dashboard">
      ...
      <div class="browser" role="img" aria-label="Simulación interactiva del panel de control de Themis con expedientes activos, alertas en tiempo real y vencimientos de la semana">
...
<section class="anatomy" id="anatomy">
  ...
  <div class="product-grid">
    ...
    <div class="pcard">
      ...
      <div class="pcard-canvas" role="img" aria-label="Simulación de la lista de expedientes activos en Themis">
    ...
    <div class="pcard">
      ...
      <div class="pcard-canvas" role="img" aria-label="Simulación del calendario mensual y agenda diaria de vencimientos en Themis">
        <div class="mock" style="padding:14px">
    ...
    <div class="pcard">
      ...
      <div class="pcard-canvas" role="img" aria-label="Simulación de tareas de procuración asignadas con estado pendiente y prioridad en Themis">
        <div class="mock" style="padding:14px">
    ...
    <div class="pcard">
      ...
      <div class="pcard-canvas" role="img" aria-label="Simulación del monitoreo automático de expedientes de la Mesa de Entradas Virtual (MEV) en Themis">
        <div class="mock" style="padding:14px">
    ...
    <div class="pcard">
      ...
      <div class="pcard-canvas" role="img" aria-label="Simulación de control automatizado del Portal de Causas del Poder Judicial de la Nación (PJN) en Themis">
        <div class="mock" style="padding:14px">
          <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px">
            <div>
    ...
    <div class="pcard">
      ...
      <div class="pcard-canvas" role="img" aria-label="Simulación del directorio de contactos clasificados por rol en Themis">
        <div class="mock" style="padding:14px">
  ...
  <div class="cta-inner">
    <div>
      ...
      <div class="cta-actions">
        <a href="https://wa.me/5491144074979?text=Hola%2C%20me%20gustar%C3%ADa%20solicitar%20una%20demo%20personalizada%20de%20Themis." target="_blank" rel="noopener noreferrer" class="btn btn-primary accent lg" aria-label="Solicitar demo personalizada por WhatsApp">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/></svg>
          Solicitar demo
        </a>
      </div>
...
<footer class="site">
  <div class="footer-inner">
    <div class="foot-brand">
      <a href="#" class="brand" aria-label="Themis — Volver al inicio">
        <svg class="brand-mark" width="28" height="28" viewBox="0 0 80 80" fill="none" role="img" aria-label="Balanza de la justicia estilizada">
          <title>Logo de Themis</title>
          <polygon points="40,12 36,18 44,18" fill="var(--obsidian)"/>
          <line x1="40" y1="18" x2="40" y2="56" stroke="var(--obsidian)" stroke-width="3"/>
          <line x1="18" y1="30" x2="62" y2="30" stroke="var(--obsidian)" stroke-width="3"/>
    ...
    <div class="foot-col">
      <h4>Soporte</h4>
      <a href="https://wa.me/5491144074979?text=Hola%2C%20quisiera%20ponerme%20en%20contacto%20con%20el%20equipo%20de%20Themis." target="_blank" rel="noopener noreferrer" aria-label="Ponerse en contacto con Themis vía WhatsApp">Contacto</a>
      <a href="https://wa.me/5491144074979?text=Hola%2C%20me%20comunico%20desde%20la%20web%20de%20Themis." target="_blank" rel="noopener noreferrer" aria-label="Contactar a Themis por WhatsApp">WhatsApp</a>
    </div>
    <div class="foot-col">
      <h4>Legal</h4>
...
<!-- WHATSAPP FLOAT -->
<a href="https://wa.me/5491144074979?text=Hola%2C%20estoy%20viendo%20la%20web%20de%20Themis%20y%20tengo%20una%20consulta." target="_blank" rel="noopener noreferrer" class="wa" aria-label="Abrir chat de WhatsApp con Themis">
...
export default function Page() {
  ...
  const softwareSchema = {
    ...
    "description": "Plataforma de gestión procesal premium para estudios jurídicos en Argentina que automatiza el monitoreo de expedientes y la agenda judicial.",
    "offers": {
      "@type": "Offer",
      "price": "0",
      "priceCurrency": "ARS",
      "description": "Prueba gratuita de 14 días y planes a medida."
    }
  };
  ...
  const organizationSchema = {
    ...
    "logo": "https://themis.com.ar/icon.svg",
    "email": "contacto@themis.com.ar",
    "telephone": "+5491144074979",
    "contactPoint": [
      {
        "@type": "ContactPoint",
        "telephone": "+54-9-11-4407-4979",
        "contactType": "sales",
        "email": "contacto@themis.com.ar",
        "areaServed": "AR",
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "¿Pierdo horas revisando el MEV expediente por expediente, cada mañana?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Themis sincroniza MEV y PJN una vez al día. Vea las actualizaciones de cada movimiento, resolución o nueva providencia consolidadas en su panel. No abra un portal judicial nunca más."
        }
      },
      {
        "@type": "Question",
        "name": "¿Se me está por escapar un plazo procesal — otra vez?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Vencimientos priorizados por urgencia real. Calendario unificado con plazos, audiencias y tareas de procuración. Vea los próximos compromisos y vencimientos del día en un solo lugar."
        }
      },
      {
        "@type": "Question",
        "name": "¿Tengo los expedientes en cinco lugares distintos?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Todo centralizado, todo buscable. Expedientes, movimientos, escritos, contactos, juzgados y entidades — desde cualquier dispositivo con búsqueda universal integrada."
        }
      },
      {
        "@type": "Question",
        "name": "¿Cuánto le debe cada cliente — y cuánto facturé este mes?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Módulo para gestionar finanzas. Registre honorarios acordados, adelantos, gastos causídicos y saldos de manera organizada."
        }
      },
      {
        "@type": "Question",
        "name": "¿Cómo controlo lo que hacen los procuradores en el terreno?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Cada diligencia queda documentada, con devolución. Asigne tareas con contexto completo del expediente. Seguimiento en tiempo real, ubicación y confirmación de resolución."
        }
      }
    ]
  };
