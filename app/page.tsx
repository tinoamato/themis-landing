  ...
  <div class="hero-grid">
    <div class="hero-left">
      ...
      <div class="hero-actions">
        <a href="#" class="btn btn-primary accent lg">
...
<section class="pricing" id="precios">
  ...
  <div class="price-table">
    ...
    <div class="pt-cell footer"><a href="#" class="pt-cta out">Comenzar →</a></div>
    <div class="pt-cell footer"><a href="#" class="pt-cta fill">Prueba 14 días →</a></div>
    <div class="pt-cell footer"><a href="#" class="pt-cta out">Contactar ventas →</a></div>
  </div>
  ...
  <div class="cta-inner">
    <div>
      ...
      <div class="cta-actions">
        <a href="#" class="btn btn-primary ivory lg">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/></svg>
          Solicitar demo
        </a>
        <a href="#" class="btn btn-ghost dark lg">Hablar con asesor</a>
      </div>
